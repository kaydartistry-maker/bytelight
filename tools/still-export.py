...
dimensions, save at full colour, and only start reducing colours if the file is
...
def main() -> int:
    ...
    parser.add_argument("--no-reduce", action="store_true", help="Never reduce colours, even if over budget.")
